      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center space-x-6">
            ...
            {onEdit && (
              <Button onClick={onEdit} className="flex items-center gap-2 px-3 py-2">
                <Edit className="h-4 w-4" />
                {/* Ẩn text trên mobile, chỉ hiện ở md trở lên */}
                <span className="hidden md:inline">{t('user_info.edit')}</span>
              </Button>
            )}
          </div>
        </CardContent>
