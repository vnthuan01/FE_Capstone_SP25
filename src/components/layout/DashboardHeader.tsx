    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200 dark:border-[#233648] bg-surface-light dark:bg-[#111a22] px-6 py-3 h-16">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="cursor-pointer hidden lg:flex items-center justify-center size-8 text-slate-500 hover:text-primary dark:text-[#92adc9] dark:hover:text-white transition-colors rounded-md hover:bg-slate-100 dark:hover:bg-[#1c2a38]"
        ...
        <button
          onClick={onMenuClick}
          className="cursor-pointer lg:hidden text-slate-500 hover:text-primary transition-colors"
        >
      ...
      <div className="flex flex-1 justify-end items-center gap-4">
        ...
        {/* Notifications */}
        <button className="cursor-pointer relative p-2 text-slate-500 hover:text-primary dark:text-[#92adc9] dark:hover:text-white transition-colors">
